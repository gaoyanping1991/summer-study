...
// ===== 古诗库（30首） =====
// ===== 五年级上册必背内容库（按单元顺序排列） =====
// 暑假每天推送一条，按顺序从第一单元开始，轮完一圈再从头来
const RECITE_BANK = [
  // ========== 第一单元：万物有灵 ==========
  // 第1课 白鹭（课文段落）
  {title:'白鹭·外形之美',author:'郭沫若',unit:'第一单元',unitIdx:1,type:'课文',content:'那雪白的蓑毛，那全身的流线型结构，那铁色的长喙，那青色的脚，增之一分则嫌长，减之一分则嫌短，素之一忽则嫌白，黛之一忽则嫌黑。',translation:'雪白的羽毛、流线型的身体、铁色的长嘴、青色的脚——增加一点就太长，减少一点就太短，白一点就太白，黑一点就太黑。一切都刚刚好。',appreciation:'运用排比句式描写白鹭外形，强调白鹭的"适宜"之美。"蓑毛"指像蓑衣一样的羽毛。"喙"读huì，鸟嘴。'},
  {title:'白鹭·水田钓鱼',author:'郭沫若',unit:'第一单元',unitIdx:1,type:'课文',content:'在清水田里，时有一只两只白鹭站着钓鱼，整个的田便成了一幅嵌在琉璃框里的画面。田的大小好像是有心人为白鹭设计出的镜匣。',translation:'清水田中白鹭钓鱼的画面，就像一幅镶在玻璃框里的画，田的大小好像专门为白鹭定做的镜框。',appreciation:'将白鹭钓鱼比作"嵌在琉璃框里的画"，意境优美。"琉璃"指光滑透明的玻璃。"镜匣"指装镜子的盒子。'},
  {title:'白鹭·清晨瞭望',author:'郭沫若',unit:'第一单元',unitIdx:1,type:'课文',content:'晴天的清晨，每每看见它孤独地站立于小树的绝顶，看来像是不安稳，而它却很悠然。这是别的鸟很难表现的一种嗜好。人们说它是在望哨，可它真是在望哨吗？',translation:'晴天清晨，白鹭站在小树顶上，看起来不稳当，它却很自在。这是别的鸟很难做到的一种爱好。',appreciation:'设问句引发思考。"绝顶"指最高处。"嗜好"读shìhào，特别的爱好。注意"瞭望"的"瞭"不要写成"了"。'},
  {title:'白鹭·黄昏低飞',author:'郭沫若',unit:'第一单元',unitIdx:1,type:'课文',content:'黄昏的空中偶见白鹭的低飞，更是乡居生活中的一种恩惠。那是清澄的形象化，而且具有了生命了。',translation:'黄昏偶尔看见白鹭低飞，是乡村生活中一种美好的恩赐。那是清澈透明的形象化，而且有了生命。',appreciation:'将白鹭低飞比作"清澄的形象化"。"恩惠"指好处、恩赐。"清澄"指清澈明净。'},
  // 第2课 落花生（课文段落）
  {title:'落花生·可贵品质',author:'许地山',unit:'第一单元',unitIdx:1,type:'课文',content:'父亲说："花生的好处很多，有一样最可贵：它的果实埋在地里，不像桃子、石榴、苹果那样，把鲜红嫩绿的果实高高地挂在枝头上，使人一见就生爱慕之心。你们看它矮矮地长在地上，等到成熟了，也不能立刻分辨出来它有没有果实，必须挖起来才知道。"',translation:'花生最可贵的品质：果实埋在土里，不炫耀，不张扬，默默奉献。不像桃子石榴苹果那样把果实高高挂在枝头。',appreciation:'借物喻人——用花生比喻朴实无华、默默奉献的人。注意"爱慕"的"慕"下部是"小"+"⺗"。'},
  {title:'落花生·做有用的人',author:'许地山',unit:'第一单元',unitIdx:1,type:'课文',content:'父亲接下去说："所以你们要像花生，它虽然不好看，可是很有用。"\n我说："那么，人要做有用的人，不要做只讲体面，而对别人没有好处的人。"',translation:'父亲说：要像花生一样，虽然不好看但很有用。我说：人要做有用的人，不要只追求外表好看。',appreciation:'全文中心思想——"人要做有用的人，不要做只讲体面而对别人没有好处的人"。这是全文的主旨句。'},
  // 第3课 桂花雨（课文段落）
  {title:'桂花雨·桂花香',author:'琦君',unit:'第一单元',unitIdx:1,type:'课文',content:'桂花盛开的时候，不说香飘十里，至少前后左右十几家邻居，没有不浸在桂花香里的。',translation:'桂花盛开时，香气弥漫，周围十几家邻居都沉浸在桂花香里。',appreciation:'用"浸"字写出桂花香气的浓郁和无处不在。"浸"读jìn，泡在液体里，这里形容被香气包围。'},
  {title:'桂花雨·摇花乐',author:'琦君',unit:'第一单元',unitIdx:1,type:'课文',content:'摇哇摇，桂花纷纷落下来，我们满头满身都是桂花。我喊着："啊！真像下雨，好香的雨呀！"',translation:'摇动桂花树，桂花像雨一样纷纷落下，落得满头满身都是，香气扑鼻。',appreciation:'"桂花雨"的由来——桂花纷纷落下像下雨一样。表达了作者对童年和故乡的怀念之情。'},
  {title:'桂花雨·思乡情',author:'琦君',unit:'第一单元',unitIdx:1,type:'课文',content:'这里的桂花再香，也比不上家乡院子里的桂花。',translation:'母亲说：这里的桂花再香，也比不上家乡院子里的桂花。',appreciation:'借桂花表达浓浓的思乡之情。月是故乡明，桂花是故乡香。这是全文的点睛之笔。'},
  // 第4课 珍珠鸟（课文段落）
  {title:'珍珠鸟·外形描写',author:'冯骥才',unit:'第一单元',unitIdx:1,type:'课文',content:'红嘴红脚，灰蓝色的毛，只是后背还没生出珍珠似的圆圆的白点。它好肥，整个身子好像一个蓬松的球儿。',translation:'珍珠鸟红嘴红脚灰蓝毛，后背有珍珠般的白点，身子肥肥的像个蓬松的球。',appreciation:'外形描写生动可爱。"蓬松"的"蓬"是草字头。比喻句：身子像蓬松的球儿。'},
  {title:'珍珠鸟·信赖',author:'冯骥才',unit:'第一单元',unitIdx:1,type:'课文',content:'信赖，往往创造出美好的境界。',translation:'信任，往往能创造出美好的境界。',appreciation:'全文中心句。珍珠鸟从怕人到信任人，说明信赖的力量。这是全文最重要的句子，常考默写。'},
  // 语文园地一·日积月累
  {title:'蝉',author:'虞世南',dynasty:'唐',unit:'第一单元',unitIdx:1,type:'日积月累',content:'垂緌饮清露，\n流响出疏桐。\n居高声自远，\n非是藉秋风。',translation:'蝉垂下触须饮着清露，鸣声从稀疏的梧桐树中传出。身居高处声音自然传得远，不是凭借秋风的力量。',appreciation:'借蝉喻人，品德高尚的人不需要外在凭借。"緌"读ruí，指蝉的触须。"藉"读jiè，凭借。'},

  // ========== 第二单元：阅读要有一定速度 ==========
  // 第5课 搭石（课文段落）
  {title:'搭石·协调有序',author:'刘章',unit:'第二单元',unitIdx:2,type:'课文',content:'每当上工、下工，一行人走搭石的时候，动作是那么协调有序！前面的抬起脚来，后面的紧跟上去。嗒嗒的声音，像轻快的音乐；清波漾漾，人影绰绰，给人画一般的美感。',translation:'人们走搭石时，动作协调有序，前面的抬脚后面的跟上，嗒嗒声像轻快的音乐，水波荡漾人影晃动，像画一样美。',appreciation:'描写走搭石的画面美和音乐美。"绰绰"读chuòchuò，姿态柔美的样子。"漾漾"读yàngyàng。'},
  {title:'搭石·美好情感',author:'刘章',unit:'第二单元',unitIdx:2,type:'课文',content:'一排排搭石，任人走，任人踏，它们联结着故乡的小路，也联结着乡亲们美好的情感。',translation:'搭石连接着故乡的小路，也连接着乡亲们美好的情感。',appreciation:'借物抒情——搭石不仅是路，更是乡亲们互助互爱精神的象征。这是全文的点睛句。'},
  // 语文园地二·日积月累（惜时名言）
  {title:'惜时名言',author:'',unit:'第二单元',unitIdx:2,type:'日积月累',content:'不饱食以终日，不弃功于寸阴。 ——葛洪\n盛年不重来，一日难再晨。及时当勉励，岁月不待人。 ——陶渊明\n莫等闲，白了少年头，空悲切。 ——岳飞',translation:'不要整天吃饱了无所事事，不要浪费一寸光阴。壮年不会重来，一天不会有两个早晨。应当及时勉励自己，岁月不等人。不要虚度光阴，等头发白了才空自悲伤。',appreciation:'三条关于珍惜时间的名言。"莫等闲"出自岳飞《满江红》。"寸阴"指极短的时间。'},

  // ========== 第三单元：民间故事 ==========
  // 语文园地三·日积月累
  {title:'乞巧',author:'林杰',dynasty:'唐',unit:'第三单元',unitIdx:3,type:'日积月累',content:'七夕今宵看碧霄，\n牵牛织女渡河桥。\n家家乞巧望秋月，\n穿尽红丝几万条。',translation:'七夕之夜仰望碧蓝的天空，牛郎织女渡过银河相会。家家户户对着秋月乞求巧手，穿完了千万条红丝线。',appreciation:'描写七夕乞巧的民间习俗。注意两个"宵/霄"的区别：第一个"宵"是夜晚，第二个"霄"是天空。'},

  // ========== 第四单元：爱国情怀 ==========
  // 第12课 古诗三首
  {title:'示儿',author:'陆游',dynasty:'宋',unit:'第四单元',unitIdx:4,type:'古诗',content:'死去元知万事空，\n但悲不见九州同。\n王师北定中原日，\n家祭无忘告乃翁。',translation:'人死后原本知道万事皆空，只是悲叹看不到国家统一。当宋朝军队收复中原的那天，家祭时别忘了告诉你的父亲。',appreciation:'陆游绝笔诗，至死不渝的爱国之情。"元知"不要写成"原知"。"九州"指中国。"乃翁"指你的父亲。'},
  {title:'题临安邸',author:'林升',dynasty:'宋',unit:'第四单元',unitIdx:4,type:'古诗',content:'山外青山楼外楼，\n西湖歌舞几时休？\n暖风熏得游人醉，\n直把杭州作汴州。',translation:'山外有青山楼外有楼，西湖的歌舞什么时候才能停止？暖风把游人熏得醉醺醺的，简直把杭州当成了汴州。',appreciation:'讽刺南宋权贵沉迷享乐、忘记国耻。"熏"不要写成"醺"。"汴州"是北宋都城开封。'},
  {title:'己亥杂诗',author:'龚自珍',dynasty:'清',unit:'第四单元',unitIdx:4,type:'古诗',content:'九州生气恃风雷，\n万马齐喑究可哀。\n我劝天公重抖擞，\n不拘一格降人才。',translation:'中国的生机勃勃需要风雷般的变革，万马齐喑的局面实在可悲。我劝老天爷重新振作，不拘一格降下人才。',appreciation:'表达对社会变革的渴望。"恃"读shì，依靠。"喑"读yīn，沉默。"抖擞"读dǒusǒu，振作。'},
  // 第13课 少年中国说（节选）
  {title:'少年中国说·责任',author:'梁启超',unit:'第四单元',unitIdx:4,type:'课文',content:'故今日之责任，不在他人，而全在我少年。少年智则国智，少年富则国富；少年强则国强，少年独立则国独立；少年自由则国自由；少年进步则国进步；少年胜于欧洲则国胜于欧洲；少年雄于地球则国雄于地球。',translation:'今天的责任不在别人，全在我们少年。少年智慧国家就智慧，少年富强国家就富强……',appreciation:'排比句式气势磅礴，层层递进强调少年对国家的重要性。要求全文背诵。'},
  {title:'少年中国说·光辉前景',author:'梁启超',unit:'第四单元',unitIdx:4,type:'课文',content:'红日初升，其道大光。河出伏流，一泻汪洋。潜龙腾渊，鳞爪飞扬。乳虎啸谷，百兽震惶。鹰隼试翼，风尘翕张。奇花初胎，矞矞皇皇。干将发硎，有作其芒。',translation:'红日初升光芒万丈，黄河奔流一泻汪洋。潜龙从深渊腾飞，幼虎在山谷咆哮，鹰隼展翅试飞，奇花含苞待放，宝剑刚刚磨出锋芒。',appreciation:'运用比喻和排比描绘中国的光辉前景。"隼"读sǔn，"翕"读xī，"矞"读yù，"硎"读xíng。'},
  {title:'少年中国说·祝福',author:'梁启超',unit:'第四单元',unitIdx:4,type:'课文',content:'天戴其苍，地履其黄。纵有千古，横有八荒。前途似海，来日方长。\n美哉，我少年中国，与天不老！壮哉，我中国少年，与国无疆！',translation:'头顶苍天，脚踏黄土。纵看有千年历史，横看有八方疆土。前途像大海一样宽广，未来的日子还很长。美哉少年中国与天不老！壮哉中国少年与国无疆！',appreciation:'结尾升华，气势恢宏。"八荒"指四面八方遥远的地方。"无疆"指没有边界，永远。'},
  // 语文园地四·日积月累
  {title:'勤俭名言',author:'',unit:'第四单元',unitIdx:4,type:'日积月累',content:'克勤于邦，克俭于家。 ——《尚书》\n居安思危，戒奢以俭。 ——魏征\n由俭入奢易，由奢入俭难。 ——司马光',translation:'在国家大事上要勤奋，在家庭生活中要节俭。在安定的时候要想到危险，戒除奢侈保持节俭。从节俭到奢侈很容易，从奢侈回到节俭很难。',appreciation:'三条关于勤俭节约的名言，出自《尚书》、魏征、司马光。'},

  // ========== 第七单元：四时景物皆成趣 ==========
  // 第21课 古诗三首
  {title:'山居秋暝',author:'王维',dynasty:'唐',unit:'第七单元',unitIdx:7,type:'古诗',content:'空山新雨后，\n天气晚来秋。\n明月松间照，\n清泉石上流。\n竹喧归浣女，\n莲动下渔舟。\n随意春芳歇，\n王孙自可留。',translation:'空山刚下过雨，傍晚的天气已有秋意。明月透过松林照下，清泉在石上流淌。竹林喧闹是洗衣女归来，莲花摇动是渔船下水。任凭春花凋谢，王孙自可留在此山。',appreciation:'王维山水诗代表作，动静结合、诗中有画。"暝"读míng，傍晚。"浣"读huàn，洗衣。'},
  {title:'枫桥夜泊',author:'张继',dynasty:'唐',unit:'第七单元',unitIdx:7,type:'古诗',content:'月落乌啼霜满天，\n江枫渔火对愁眠。\n姑苏城外寒山寺，\n夜半钟声到客船。',translation:'月亮落下乌鸦啼叫寒霜满天，江边枫树和渔火伴着愁眠。姑苏城外的寒山寺，半夜的钟声传到了客船上。',appreciation:'羁旅思乡的名篇。"乌"不要写成"鸟"。"姑苏"是苏州古称。以动衬静——钟声反衬夜的寂静。'},
  {title:'长相思',author:'纳兰性德',dynasty:'清',unit:'第七单元',unitIdx:7,type:'词',content:'山一程，水一程，身向榆关那畔行，夜深千帐灯。\n风一更，雪一更，聒碎乡心梦不成，故园无此声。',translation:'翻过一座座山，渡过一条条河，向着山海关那边行进，深夜中千座帐篷灯火通明。风刮一阵，雪下一阵，嘈杂声搅碎了思乡之心，家乡没有这种声音。',appreciation:'清代词人纳兰性德描写行军途中的思乡之情。"榆关"即山海关。"聒"读guō，嘈杂。'},
  // 第22课 四季之美（节选）
  {title:'四季之美·春',author:'清少纳言',unit:'第七单元',unitIdx:7,type:'课文',content:'春天最美是黎明。东方一点儿一点儿泛着鱼肚色的天空，染上微微的红晕，飘着红紫红紫的彩云。',translation:'春天最美的是黎明时分，东方天空泛起鱼肚白，染上红晕，飘着红紫色的彩云。',appreciation:'日本作家清少纳言的散文。"鱼肚色"指鱼肚子的白色。"红晕"的"晕"读yùn。'},
  {title:'四季之美·夏',author:'清少纳言',unit:'第七单元',unitIdx:7,type:'课文',content:'夏天最美是夜晚。明亮的月夜固然美，漆黑漆黑的暗夜，也有无数的萤火虫翩翩飞舞。即使是蒙蒙细雨的夜晚，也有一只两只萤火虫，闪着朦胧的微光在飞行，这情景着实迷人。',translation:'夏天最美的是夜晚，明亮的月夜美，漆黑的暗夜也有萤火虫翩翩飞舞，蒙蒙细雨的夜晚萤火虫闪着朦胧微光，着实迷人。',appreciation:'描写三种夏夜的美——月夜、暗夜、雨夜，各有不同的美。"翩翩"形容轻快地飞舞。"着实"读zhuóshí，确实。'},
  // 语文园地七·日积月累
  {title:'渔歌子',author:'张志和',dynasty:'唐',unit:'第七单元',unitIdx:7,type:'日积月累',content:'西塞山前白鹭飞，\n桃花流水鳜鱼肥。\n青箬笠，绿蓑衣，\n斜风细雨不须归。',translation:'西塞山前白鹭飞翔，桃花盛开江水涨，鳜鱼正肥美。头戴青斗笠，身披绿蓑衣，斜风细雨中不必归去。',appreciation:'描写渔人自在生活。"鳜"读guì，不要写成"桂"。"箬"读ruò。"蓑"读suō。'},

  // ========== 第八单元：读书明智 ==========
  // 第25课 古人谈读书
  {title:'古人谈读书·论语',author:'孔子',unit:'第八单元',unitIdx:8,type:'课文',content:'知之为知之，不知为不知，是知也。\n敏而好学，不耻下问。\n默而识之，学而不厌，诲人不倦。',translation:'知道就是知道，不知道就是不知道，这才是真正的智慧。聪明而且好学，不以向地位低的人请教为耻。默默记住，学习永不满足，教导别人永不疲倦。',appreciation:'出自《论语》。"知"最后一个读zhì，同"智"。"识"读zhì，记住。"诲"读huì，教导。'},
  {title:'古人谈读书·朱熹',author:'朱熹',unit:'第八单元',unitIdx:8,type:'课文',content:'余尝谓读书有三到，谓心到、眼到、口到。心不在此，则眼不看仔细，心眼既不专一，却只漫浪诵读，决不能记，记亦不能久也。三到之中，心到最急。心既到矣，眼口岂不到乎？',translation:'我曾经说读书有三到：心到、眼到、口到。心不在这里，眼睛就看不仔细。心和眼不专一，只是随便朗读，一定记不住，记住了也不能持久。三到之中，心到最重要。心到了，眼和口怎么会不到呢？',appreciation:'朱熹论读书方法。强调读书要专心致志。"漫浪"指随意、不认真。"岂"表示反问，相当于"怎么"。'},
  // 语文园地八·日积月累
  {title:'观书有感（其一）',author:'朱熹',dynasty:'宋',unit:'第八单元',unitIdx:8,type:'日积月累',content:'半亩方塘一鉴开，\n天光云影共徘徊。\n问渠那得清如许？\n为有源头活水来。',translation:'半亩方形池塘像一面镜子打开，天光和云影在水中一起徘徊。问它为什么这样清澈？因为有源头的活水不断流来。',appreciation:'以池塘为喻，说明不断学习新知识的重要性。"鉴"指镜子。"渠"指它（池塘）。"为"读wèi，因为。'},
  {title:'观书有感（其二）',author:'朱熹',dynasty:'宋',unit:'第八单元',unitIdx:8,type:'日积月累',content:'昨夜江边春水生，\n艨艟巨舰一毛轻。\n向来枉费推移力，\n此日中流自在行。',translation:'昨夜江边春水涨起，大战船像羽毛一样轻。以前白费了推移的力气，今天在江中可以自由航行。',appreciation:'以行船为喻，说明积累到一定程度自然水到渠成。"艨艟"读méngchōng，古代战船。'},
];

// 背诵起始日期：暑假第一天（2026年7月1日），按顺序每天推送一条
const RECITE_START_DATE = '2026-07-01';
function getDailyRecite() {
  const today = todayStr();
  const start = new Date(RECITE_START_DATE);
  const now = new Date(today);
  const diffDays = Math.floor((now - start) / (1000 * 60 * 60 * 24));
  const idx = ((diffDays % RECITE_BANK.length) + RECITE_BANK.length) % RECITE_BANK.length;
  return RECITE_BANK[idx];
}
  ...
  if(h.type==='recite'){
    ...
    contentHTML=`<div class="poetry-card">
      <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
        ...
        ${p.unit?`<span style="display:inline-block;background:rgba(0,0,0,0.05);color:#666;font-size:11px;font-weight:500;padding:2px 10px;border-radius:10px;">${p.unit}</span>`:''}
      </div>
